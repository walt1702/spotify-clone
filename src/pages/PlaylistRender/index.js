...
import { fetchPlaylistData } from '../../state/ducks/userCollection/actions';
    ...
    return(
        <div className = "playlistPage">
            ...
            <div className = "introdiv">
                <img src = {playlistDetails?.images[0]?.url} alt = ""/>
                <div className = "body__infoText">
                    <p className = "boldextra">PLAYLIST</p>
                    <h1 className = "name">{playlistDetails?.name}</h1>
                    <p className = "extra">{playlistDetails?.description}</p>

                    <p className = "extra">
                        <span className = "boldextra">{playlistDetails?.owner?.display_name}</span>
...
{/* 
                ...
                <Songs songs = {playlistDetails?.tracks?.items}/>
                </>
                }
        </div>
    )
