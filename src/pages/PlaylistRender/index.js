...
import { fetchFollowedTracks, fetchPlaylistData } from '../../state/ducks/userCollection/actions';
...
function PlaylistRender()
{
    ...
    const user = useSelector(state=>state.authentication.userProfile.display_name);
    useEffect(()=>{
        ...
        <div className = "playlistPage">
            ...
            <div className = "introdiv">
                ...
                <div className = "body__infoText">
                    ...
                    <p className = "extra">
                        <span className = "boldextra">{playlistId!==undefined ? playlistDetails?.owner?.display_name : user}</span>
            ...
            <div className="buttonsdiv">
                    ...
                    </button>
                    {
                       ...
                       <div> <button title="Save to Your Library" className="otherbtn">
